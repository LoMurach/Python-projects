# Bitcoin price prediction algorithm using an API from coinranking.com
...
model = load_model("coinpredictor.h5")
...
# Loading the train model and making predicitions using the x_test values
...
iplot(prices.iplot(asFigure=True, kind='scatter', xTitle='Date', yTitle='BTC Price', title='BTC Price Predictions'))
